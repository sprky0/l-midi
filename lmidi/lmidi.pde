...
int noteTransposition = -24; // some base lowest note (note + this becomes our '0')
		...
		MetaEventListener mel = new MetaEventListener() {
			...
			public void meta(MetaMessage meta) {
				...
				if (lastNoteState[zip[1]] != noteState[zip[1]]) {
					int noteValue = noteState[zip[1]] == 1 ? '1' : '0'; // convert to our char
